import l from"express";import p from"argon2";import{Pool as f}from"pg";import w from"dotenv";w.config();var h=new f({connectionString:process.env.POSTGRES_URL,ssl:{rejectUnauthorized:!1}}),i=h;import d from"jsonwebtoken";import{rateLimit as y}from"express-rate-limit";function u(s){return`
        <!doctype html>
        <html>
            <head>
                <meta charset="UTF-8" />
    ...
    `,[t.name,t.click_count,t.id]),t.password){let c=await p.hash(t.password);await i.query(`
            ...
            SET hash_password = $1
            WHERE id = $2;
        `,[c,t.id]),delete t.password}e.status(200).json({error:null,token:m(t)})});var T=o;export{T as default};
